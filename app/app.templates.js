angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/dashboard/dashboard.template.html',
    ...
    "        top: 14%;\n" +
    "        left: 17%;\n" +
    "      '\"><body-suit class=body-suit-directive-object></body-suit></hud-element><hud-animation class=body-suit-animation src=\"'images/bottom-hud.png'\"></hud-animation></div><div class=video-feed><hud-element class=video-feed-directive border=\"'images/borders/video-feed.png'\" cover=true><video-feed src=\"'images/placeholder.png'\"></video-feed>{{selectedFeed.label}}</hud-element><hud-animation class=video-feed-animation src=\"'images/right-hud.png'\"></hud-animation><hud-element class=video-feed-thumbnails border=\"'images/borders/thumbnails.png'\" content-position=\"'\n" +
    "        width: 85%;\n" +
    "        height: 50%;\n" +
    "        top: 20%;\n" +
    "        left: 1%;\n" +
